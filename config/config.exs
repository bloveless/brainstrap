...
config :brainstrap, BrainstrapWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: BrainstrapWeb.ErrorHTML, json: BrainstrapWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Brainstrap.PubSub,
  live_view: [signing_salt: "R07mTSNc"]
